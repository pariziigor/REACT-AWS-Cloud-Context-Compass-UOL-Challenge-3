      ...
      <div className="flex  gap-10 p-10">
        ...
        <section className="space-y-5 rounded-xl bg-dark-30 p-10">
          ...
          <div className="space-y-4">
            ...
            <p>
              <span className="mr-4 text-dark-20">interesses no Orkut:</span>
              Solteiro
            </p>
            <p>
            ...
            <p>
              <span className="mr-4 text-dark-20">Filhos:</span>
              Não
            </p>
            <p>
              <span className="mr-4 text-dark-20">Sexo:</span>
              Masculino
            </p>
            <p>
              <span className="mr-4 text-dark-20">Fumo:</span>
              Não
            </p>
            <p>
              <span className="mr-4 text-dark-20">Bebo:</span>
              Depende do dia
            </p>
            <p>
