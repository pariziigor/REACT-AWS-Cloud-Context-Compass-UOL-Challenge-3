...
import ProfileImage from "../CardImage/ProfileImage";
...
function ProfileComponent() {
  return (
    <div className="gap-8 justify-center items-center  w-full flex flex-col py-10 lg:flex-row">
      <CardComponents.Root>
        <CardComponents.Img src="https://i.imgur.com/jguCgC7.png" textName="Hello, world!" textInfo="Solteiro, Brasil" />
      ...
      <AsideComponents.Root>
        <AsideComponents.Container>
          <AsideComponents.Link href="/profile" text="Amigos (248)" className="text-base text-dark-10" />
          <AsideComponents.Link href="/profile" text="Ver todos" className="text-sm text-brand-color" />
        </AsideComponents.Container>
      ...
      <AsideComponents.Root>
        <AsideComponents.Container>
          <AsideComponents.Link href="/profile" text="Comunidade (42)" className="text-base text-dark-10" />
          <AsideComponents.Link href="/profile" text="Ver todos" className="text-sm text-brand-color" />
        </AsideComponents.Container>
        <AsideComponents.ContainerBody>
          <AsideComponents.Object
